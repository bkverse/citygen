...
public class AutoRoadCreator_V3 : EditorWindow
{
    ...
    GameObject TheMap;
    bool up, dowm, left, right, MapUpdated;
    ...
    [MenuItem("Window/Auto Road Creator v3.0")]
    private static void OpenWindow()
    {
        AutoRoadCreator_V3 window = GetWindow<AutoRoadCreator_V3>();
        window.titleContent = new GUIContent("Auto Road Creator v3.0");
    }
